...
require('lazy').setup({
  ...
  --emddom
  --    spec = {
  --     -- This is the crucial line for your setup:
  ...
  ---- emddom
  --- https://typecraft.dev/neovim-for-newbs/a-modular-configuration
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- catppuccin: any other, such as 'catppuccin-latte', 'catppuccin-frappe', 'catppuccin-macchiato', 'catppuccin-mocha'.
  ...
  -- emddom  -- this doesn't load the plugin
